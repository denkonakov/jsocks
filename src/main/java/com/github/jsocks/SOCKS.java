...
public class SOCKS
{
	...
	{
		System.out.println("Usage: java com.github.jsocks.SOCKS [inifile1 inifile2 ...]\n"
			+ "If none inifile is given, uses com.github.jsocks.socks.properties.\n");
	}
	...
	static public void main(String[] args)
	{
		...
		if (args.length == 0)
		{
			...
			file_names[0] = "com.github.jsocks.socks.properties";
		}
		else
		{
			file_names = args;
