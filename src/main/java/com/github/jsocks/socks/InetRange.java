...
public class InetRange implements Cloneable{
    ...
    public synchronized boolean remove(String s){
      ...
      while(elements.hasMoreElements()){
        Object[] entry = (Object[]) elements.nextElement();
        if(s.equals(entry[0])){
...
/////////////////
    ...
    private synchronized boolean contains(long ip){
       Enumeration elements = all.elements();
       while(elements.hasMoreElements()){
         Object[] obj = (Object[]) elements.nextElement();
    ...
    private boolean checkHostEnding(String host){
       Enumeration elements = end_names.elements();
       while(elements.hasMoreElements()){
          if(host.endsWith((String) elements.nextElement())) return true;
       }
       return false;
    }
