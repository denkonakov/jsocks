...
/**
  ...
  <p>
  <b>NOTE:</b><br>
  Unlike other com.github.jsocks.SOCKS Sockets, it <b>does not</b> support proxy chaining,
...
public class Socks5DatagramSocket extends DatagramSocket{
    ...
    * It is not the same port to which other party should send datagrams.
      @return Port assigned by com.github.jsocks.socks server to which datagrams are send
      for association.
    */
