...
////////////////////////////////////
   /**
     Creates com.github.jsocks.SOCKS configuration dialog.<br>
     Uses default initialisation:<br>
     Proxy host: com.github.jsocks.socks-proxy <br>
     Proxy port: 1080 <br>
     Version: 5<br>
   ...
   /**
    Creates com.github.jsocks.SOCKS configuration dialog and initialises it
    to given proxy.
    */
...
////////////////
   ...
   /**
     Displays com.github.jsocks.SOCKS configuartion dialog.
     <p>
   ...
   /**
     Initialises dialog to given proxy and displays com.github.jsocks.SOCKS configuartion dialog.
     <p>
     Returns initialised proxy object, or null if user cancels dialog
     by either pressing Cancel or closing the dialog window.
    */
...
*/
   ...
   void guiInit(){
      ...
      host_text = new TextField("com.github.jsocks.socks-proxy",15);
