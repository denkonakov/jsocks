...
/**
 Exception thrown by various com.github.jsocks.socks classes to indicate errors
...
public class SocksException extends java.io.IOException{
   ...
   */
   ...
   static final String serverReplyMessage[] = { 
                  "Succeeded", 
                  "General com.github.jsocks.SOCKS server failure",
   ...
   static final String localErrorMessage[] ={
                  "com.github.jsocks.SOCKS server not specified",
                  "Unable to contact com.github.jsocks.SOCKS server",
                  "IO error",
                  "None of Authentication methods are supported",
                  "Authentication failed",
                  "General com.github.jsocks.SOCKS fault" };
