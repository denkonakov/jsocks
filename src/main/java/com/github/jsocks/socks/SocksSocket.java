 ...
 *        Proxy.setDefaultProxy("com.github.jsocks.socks-proxy",1080);
 *
 *        //OR you still use SOCKS4
 *        //Code below uses SOCKS4 proxy
 *        //Proxy.setDefaultProxy("com.github.jsocks.socks-proxy",1080,userName);
 *
...
public class SocksSocket extends Socket{
    ...
    * Connects to host port using given proxy server.
      ...
      <ul>
       ...
       <li> Connection is not allowed by the com.github.jsocks.SOCKS proxy.
       <li> com.github.jsocks.SOCKS proxy can't establish the connection.
    ...
    * Can return null if com.github.jsocks.socks server returned this address as hostname
