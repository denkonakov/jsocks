...
public class UserPasswordAuthentication implements Authentication{
   ...
   /**com.github.jsocks.SOCKS ID for User/Password authentication method*/
   ...
   /**
     ...
     @param userName User Name to send to com.github.jsocks.SOCKS server.
     @param password Password to send to com.github.jsocks.SOCKS server.
   */
