...
/**
 Classes implementing this interface should provide com.github.jsocks.socks server with
...
public interface ServerAuthenticator{
   ...
   /**
     ...
     com.github.jsocks.socks request message. For SOCKSv4 there is no authentication data and
