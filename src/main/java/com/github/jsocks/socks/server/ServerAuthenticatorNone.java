package com.github.jsocks.socks.server;

import com.github.jsocks.socks.ProxyMessage;
import com.github.jsocks.socks.UDPEncapsulation;
 ...
 * For Example: <tt><pre>
   class MyAuth extends com.github.jsocks.socks.server.ServerAuthenticator{
    ...
...
public class ServerAuthenticatorNone implements ServerAuthenticator
{
	...
	/**
	 * Constructs new ServerAuthenticatorNone object suitable for returning from the startSession
	 * function.
	 * 
	...
	/**
	 * Grants access to everyone.Removes authentication related bytes from the stream, when a SOCKS5
	 * connection is being made, selects an authentication NONE.
	 */
	 ...
	 * <p>
	 * This method reads in authentication methods that client supports, checks wether it supports
	 * given method. If it does, the notification method is written back to client, that this method
	 * have been chosen for authentication. If given method was not found, authentication failure
	 * message is send to client ([5,FF]).
	 * 
	 * @param in Input stream, version byte should be removed from the stream before calling this
	 *        method.
	...
	static public boolean selectSocks5Authentication(InputStream in, OutputStream out, int methodId) throws IOException
	{
		...
		response[0] = (byte) 5; //com.github.jsocks.SOCKS version
