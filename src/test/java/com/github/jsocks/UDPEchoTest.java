...
import java.io.*;
/**
 Plain com.github.jsocks.SOCKS unaware UDP echo server and client.
*/
public class UDPEchoTest implements Runnable{
   ...
   public UDPEchoTest(String host, int port)
   ...
   public static void usage(){
      System.err.print(
      "Usage: java com.github.jsocks.UDPEchoTest host port\n"+
      "OR\n"+
      "Usage: java com.github.jsocks.UDPEchoTest port\n");
   }
   ...
   public static void main(String args[]){
	 ...
	 try{
	     ...
	     UDPEchoTest ut = new UDPEchoTest(host,port);
