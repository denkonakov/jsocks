...
public class TestServer implements Runnable
{
	...
	/**
	 * Creates a com.github.jsocks.stubs.TestServer object which will listen on the port associated
	 * with given service.
	 * 
	 ...
	 * <p>
	 * When connection is accepted, speciefied service is performed. It is being done in separate
	 * thread.
	 * 
    ...
    /**
     * Starts the TEST Server with few different Services
     */
	public static void startServerWithAllServices()
	{
		log = System.out;
		TestService.log = log;
